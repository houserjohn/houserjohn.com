...
let project_info = [
    ...
    },
    {
        ...
        description: `
            A hub for all the projects I have worked on. It is fully responsive to the various
    ...
    },
    {
        ...
        tags: [
            {name: "JavaScript", bg: "bg-gradient-to-r from-red-400 to-red-500 " },
        ...
        description: `
            ...
            We created a multiplayer game where users can walk around
